...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-y7sgak0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-y7sgak0.containers.anotherwebservice.com/
...
```
git clone git@github.com:helenkwok/container-y7sgak0.git
cd container-y7sgak0
```
...
```
docker attach container-y7sgak0
```
